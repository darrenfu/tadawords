...
MANIFEST="$(
  cd "$(dirname "${2:-$AUDIO_ROOT/TeacherWords/ElevenLabs-Teacher-2000-v1/manifest.json}")"
  printf '%s/%s\n' "$PWD" "$(basename "${2:-$AUDIO_ROOT/TeacherWords/ElevenLabs-Teacher-2000-v1/manifest.json}")"
)"
