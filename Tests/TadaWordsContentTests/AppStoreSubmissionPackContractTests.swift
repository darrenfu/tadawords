...
final class AppStoreSubmissionPackContractTests: XCTestCase {
    ...
    func testSubmissionPackUsesCurrentEvidenceWithoutStaleClaims() throws {
        ...
        for plistPath in [
            ...
            XCTAssertTrue(plist.contains("<string>0.7.5</string>"))
            XCTAssertTrue(plist.contains("<string>2026071905</string>"))
        }
        ...
        XCTAssertTrue(project.contains("MARKETING_VERSION: 0.7.5"))
        XCTAssertTrue(project.contains("CURRENT_PROJECT_VERSION: 2026071905"))
    }
