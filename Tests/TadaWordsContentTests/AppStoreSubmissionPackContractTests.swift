...
final class AppStoreSubmissionPackContractTests: XCTestCase {
    ...
    func testSubmissionPackUsesCurrentEvidenceWithoutStaleClaims() throws {
        ...
        for plistPath in [
            ...
            XCTAssertTrue(plist.contains("<string>0.7.46</string>"))
            XCTAssertTrue(plist.contains("<string>2026072503</string>"))
        ...
        XCTAssertTrue(project.contains("MARKETING_VERSION: 0.7.46"))
        XCTAssertTrue(project.contains("CURRENT_PROJECT_VERSION: 2026072503"))
