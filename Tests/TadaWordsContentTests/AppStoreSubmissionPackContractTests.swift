...
final class AppStoreSubmissionPackContractTests: XCTestCase {
    ...
    func testSubmissionPackUsesCurrentEvidenceWithoutStaleClaims() throws {
        ...
        XCTAssertTrue(productionPlist.contains("<string>0.7.51</string>"))
        XCTAssertTrue(productionPlist.contains("<string>2026072603</string>"))
        ...
        for plistPath in ["Apps/TadaWordsApp/InfoLocalQA.plist"] {
            ...
            XCTAssertTrue(plist.contains("<string>0.7.51</string>"))
            XCTAssertTrue(plist.contains("<string>2026072603</string>"))
        ...
        XCTAssertTrue(debugPlist.contains("<string>0.7.51</string>"))
        XCTAssertTrue(debugPlist.contains("<string>2026072603</string>"))

        let project = try String(
            contentsOf: repositoryRoot.appendingPathComponent("project.yml"),
            encoding: .utf8
        )
        XCTAssertTrue(project.contains("MARKETING_VERSION: 0.7.51"))
        XCTAssertTrue(project.contains("CURRENT_PROJECT_VERSION: 2026072603"))
