...
| Persistence compatibility table | `Apps/TadaWordsApp/PersistenceSchemaCompatibility.json` | Copied to the application root to declare supported local-store schema versions | SHA-256 `ac0bec0343e049e8ee12448386b21992a6de7f67be427f6bf3f61404fbe547f3`; repository-authored runtime configuration | It contains schema names and integer versions, not user or third-party content. |
