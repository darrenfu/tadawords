...
| Swift tests | v0.7.37 adds focused immediate-match, low-confidence, and stable-partial Read-recognition coverage while retaining the ages 3–8 profile-write and App Store decision contracts and the prior release test surface; the full source gate is rerun at the immutable release HEAD |
