...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/status-v0.7.29%20QA%20Artifact%20Cleanup-6D48D7" alt="v0.7.29 QA artifact cleanup">
</p>
...
The current v0.7.29 source candidate uses Xcode 26.6. Merged v0.7.2 passed
...
./Scripts/verify-signed-app-identity.sh \
  ...
  0.7.29 2026072403 "$(git rev-parse HEAD)" com.tadawords.app.localqa
```
...
./Scripts/verify-pawgoo-development-app.py \
  ...
  0.7.29 2026072403 "$(git rev-parse HEAD)" \
...
| Version and build | v0.7.29 (`2026072403`) in source Plists and generated project settings |
| Swift tests | v0.7.29 QA artifact cleanup contracts plus current App Store decisions, atomic Family Sync, Profile chooser, and content-rights coverage; full source gate is rerun at the immutable release HEAD |
...
The [feature audit](QAArtifacts/FULL_FEATURE_AUDIT_2026-07-12.md) records the merged v0.2 implementation evidence. The [follow-up log](FOLLOWUP_BUGFIXES_AND_IMPROVEMENTS.md) records changes through v0.7.29, and the [V1 backlog](V1_BACKLOG.md) lists the remaining device and human acceptance work.
