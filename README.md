...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/status-v0.7.16%20Zodiac%20Avatars-6D48D7" alt="v0.7.16 zodiac Profile avatars">
</p>
...
The current v0.7.16 source candidate uses Xcode 26.6. Merged v0.7.2 passed
...
./Scripts/verify-signed-app-identity.sh \
  ...
  0.7.16 2026072016 "$(git rev-parse HEAD)" com.tadawords.app.localqa
```
...
./Scripts/verify-pawgoo-development-app.py \
  ...
  0.7.16 2026072016 "$(git rev-parse HEAD)" \
...
| Version and build | v0.7.16 (`2026072016`) in source Plists and generated project settings |
| Swift tests | v0.7.16 source gate: 1122/1122 plus Issue Agent and release/identity-verifier suites; committed-HEAD simulator and signed-artifact evidence pending |
