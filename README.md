...
> **Project status:** Version `0.7.9` (build `2026071909`) adds privacy-safe APNs registration observability for Family Sync. Parents and release diagnostics can distinguish not-requested, pending, registered, and coarse failed states with a timestamp, while the APNs device token is never retained, printed, hashed, persisted, or exported. Deterministic source tests are green, but exact-build signed iPhone/iPad registration and real background convergence remain separate gates under #60 and #62. The v0.7.5 [submission pack](Docs/APP_STORE_SUBMISSION_PACK_v0.7.5.md) remains internal until it is regenerated from an accepted signed release. See the [privacy inventory](Docs/APP_STORE_PRIVACY_v0.7.4.md), [content-rights inventory](Docs/APP_STORE_CONTENT_RIGHTS.md), [data manifest](Docs/FAMILY-SYNC-DATA-MANIFEST.md), [evidence matrix](Docs/FAMILY-SYNC-ACCEPTANCE-COVERAGE.md), [follow-up log](FOLLOWUP_BUGFIXES_AND_IMPROVEMENTS.md), [acceptance checklist](MVP_ACCEPTANCE.md), and [sync ADR](Docs/ADR-0001-CROSS-DEVICE-FAMILY-SYNC.md).
...
| Swift tests | Merged v0.7.2 exact HEAD: 821/821; merged v0.7.3: 822/822; v0.7.4: 834/834; v0.7.5: 837/837; v0.7.6: 998/998; v0.7.9 pre-commit gate: 1009/1009 plus 40/40 Issue Agent and 11/11 release-preflight tests |
